...
class Transaction(models.Model):
    from_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='transaction_from_user')
    to_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='transaction_to_user')
...
class Notification(models.Model):
    from_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='notification_from_user')
    to_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='notification_to_user')
    amount = models.DecimalField(decimal_places=2, max_digits=12, default=0)
